...
public class LeanAudio : object
{
     ...
     * @param {LeanAudioOptions} options:LeanAudioOptions You can pass any other values in here like vibrato or the frequency you would like the sound to be encoded at. See
     * <a href="LeanAudioOptions.html">LeanAudioOptions</a>
     * for more details.
     ...
     * <br>
     *     AnimationCurve frequencyCurve = new AnimationCurve( new Keyframe(0f, 0.003f, 0f, 0f), new Keyframe(1f, 0.003f, 0f,
     *     0f));
     *     <br>
